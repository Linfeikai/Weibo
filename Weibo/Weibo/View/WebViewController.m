...
- (void)viewDidLoad {
    ...
    NSString *urlstring = @"https://api.weibo.com/oauth2/authorize?client_id=2589579850&response_type=code&redirect_uri=https://api.weibo.com/oauth2/default.html";
...
//-(void)getAccess_tokenWith:(NSURL*)url
//{
//    NSRange rangeOne;
//    rangeOne = [url rangeOfString:@"code="];
//    //根据url中”code=”的range来得到code参数的值的range
